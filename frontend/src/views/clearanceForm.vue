                ...
                <v-card outlined elevation="5" max-width="970px" class="mx-auto">
                    ...
                    <v-row class="ma-5 pt-0">
                        <v-card-text class="mt-0 py-0">
                            For contract research and consultancies only, provide a contact name and email address:
                        </v-card-text>
                ...
                <v-card outlined elevation="5" width="100%" class="pa-0 mx-auto" max-width="970px">
                    ...
                    <v-row>
                        ...
                        <v-col class="mt-5 mr-5" style="text-align:right">
                            <i>A <a href="">Deed of Assignment</a> may be required</i>
                        </v-col>
                    </v-row>
                    <v-card-actions>
                        <v-col cols="6">
                        ...
                        <v-col cols="6">
                            <v-text-field label="UTAS discipline/unit or External Organisation" class="py-0"></v-text-field>
                        </v-col>
                        
                    </v-card-actions>
                    <v-card-actions class="py-0">
                        <v-col cols="3" class="py-0">
                            <v-card-text>Type of involvement:</v-card-text>
                        </v-col>
                        <v-col cols="3" class="py-0">
                            <v-checkbox v-model="checkbox" label="Associated with project / unpaid" class="py-0"></v-checkbox>
                        </v-col>
                        <v-col cols="3" class="py-0">
                            <v-checkbox v-model="checkbox" label="Paid from project - casual employee" class="py-0"></v-checkbox>
                        </v-col>
                        <v-col cols="3" class="py-0">
                            <v-checkbox v-model="checkbox" label="Scholarship paid from project" class="py-0"></v-checkbox>
                        </v-col>
                    </v-card-actions>
                </v-card>
            </v-row>
